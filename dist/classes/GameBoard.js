class GameBoard {
    constructor(Player) {
        this.board = [];
        this.checkAvailability = (x, y, shipLength, orientation) => {
            if (this.board[x][y] != "#")
                return false;
        ...
        this.placeShip = (x, y, shipLength, orientation, id) => {
        ...
        this.printBoard = () => console.table(this.board);
